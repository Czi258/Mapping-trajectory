...
class QuadPrismGenerator:
    ...
    def generate_random_quadrilateral(self, min_size=0.5, max_size=2.0):
        """生成随机四边形顶点（逆时针顺序）"""
        # 从随机矩形开始，然后添加随机扰动
...
def check_convexity(self, points):
    ...
    def generate_urdf(self, base_points, height, name, color=None):
        ...
        self.create_mesh_stl(base_points, height, stl_filename)
    ...
    def generate_multiple_prisms(self, num_prisms=3, output_file="prisms_info.txt"):
        """生成多个四边棱柱"""
        prisms_info = []
